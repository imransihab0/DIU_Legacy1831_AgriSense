...
| [x] | Build and use a RAG knowledge base from public agronomy sources. | ChromaDB over **11 source-attributed KB docs / 126 chunks**, incl. real gov extractions: BARC **FRG 2024**, SRDI **Soil Fertility Atlas 2020**, DAE **Agromet Advisory**, DAE **Plant Protection 2015**, BBS **Ag-Stats Yearbook 2024 yields**, **BRRI Modern Rice Cultivation** (varieties, seedbed, AWD, LCC, pest/harvest), plus a livestock guide. Each cites org/year. | Verified retrieval. A DeepSeek extraction of BARI Krishi Projukti Hatboi was REJECTED (fabricated/templated data — impossible rice yields, duplicated Rice/Potato tables). Still optional: DAM prices. |
